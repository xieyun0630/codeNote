...
### task:使用上面的方式，获取当前localhost:8080的页面信息 [	](postman_20191220070310001)
...
## 发送post请求 [	](postman_20191220070310009)
...
## 使用连接池管理器发起请求 [	](postman_20191220070310013)
...
# WebMagic [	](postman_20191220070310056)
